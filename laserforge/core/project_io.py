    ...
    def save_project(
        ...
        if isinstance(machine_settings, dict):
            ...
            m_cfg = {
                ...
                "rapid_speed": getattr(machine_settings, "rapid_speed", 4000.0),
                ...
                "overscan_enabled": getattr(machine_settings, "overscan_enabled", True),
                "overscan_pct": getattr(machine_settings, "overscan_pct", 2.5),
                "overscan_mode": getattr(machine_settings, "overscan_mode", "Acceleration"),
                "overscan_mm": getattr(machine_settings, "overscan_mm", 2.0),
                "overscan_accel_multiplier": getattr(machine_settings, "overscan_accel_multiplier", 1.2),
                "white_space_skip_enabled": getattr(machine_settings, "white_space_skip_enabled", True),
                "white_space_skip_threshold_mm": getattr(machine_settings, "white_space_skip_threshold_mm", 3.0),
                "continuous_inline_streaming": getattr(machine_settings, "continuous_inline_streaming", True),
                "flood_fill_enabled": getattr(machine_settings, "flood_fill_enabled", True),
